...
mapping RGB images and mapping poses, without semantic masks, depth
supervision, localization features, or task-specific Gaussian pruning. The
prior and every localization-map artifact exclude test images. Table~\ref{tab:indoor_protocol}
summarizes the frozen indoor protocol. Invalid 12Scenes frames whose published
poses contain non-finite values are excluded before either mapping or
evaluation.
