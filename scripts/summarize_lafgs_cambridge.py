...
TRAINING_KEYS = (
    ...
    "geometry_xyz_step_delta_skipped_point_count_changed",
    "geometry_xyz_step_nonzero_episodes",
    "geometry_source_aligned_delta_count",
    "geometry_birth0_delta_count",
    "geometry_child_delta_count",
    "raw_xyz_delta_from_initial_all_sources_mean",
    "raw_xyz_delta_from_initial_all_sources_median",
    "raw_xyz_delta_from_initial_all_sources_p95",
    "raw_xyz_delta_from_initial_all_sources_max",
    "loc_xyz_delta_from_initial_all_sources_mean",
    "loc_xyz_delta_from_initial_all_sources_median",
    "loc_xyz_delta_from_initial_all_sources_p95",
    "loc_xyz_delta_from_initial_all_sources_max",
    "raw_xyz_child_delta_from_source_mean",
    "raw_xyz_child_delta_from_source_median",
    "raw_xyz_child_delta_from_source_p95",
    "raw_xyz_child_delta_from_source_max",
    "loc_xyz_child_delta_from_source_mean",
    "loc_xyz_child_delta_from_source_median",
    "loc_xyz_child_delta_from_source_p95",
    "loc_xyz_child_delta_from_source_max",
    "direct_diag_pose_information_weight_mean_total",
    "direct_diag_pose_information_weight_mean_max",
    "direct_diag_pose_information_weight_mean_min",
    "direct_diag_pose_information_weight_max_max",
    "direct_diag_pose_information_weight_min_min",
    "direct_diag_pose_information_weight_blend_total",
    "direct_diag_pose_information_weight_floor_total",
    "direct_diag_full_bank_clean_hard_negative_loss_total",
    "direct_diag_full_bank_clean_hard_negative_loss_max",
    "direct_diag_full_bank_clean_hard_negative_weight_total",
    "direct_diag_full_bank_clean_reproj_radius_total",
    "direct_diag_full_bank_clean_hard_negatives_total",
    "direct_diag_full_bank_balance_weight_mean_total",
    "direct_diag_full_bank_balance_weight_mean_max",
    "direct_diag_full_bank_balance_weight_mean_min",
    "direct_diag_full_bank_balance_weight_max_max",
    "direct_diag_full_bank_balance_weight_min_min",
    "direct_diag_full_bank_balance_weight_blend_total",
    "direct_diag_clean_field_stage_active_total",
    "direct_diag_clean_field_full_bank_weight_scale_total",
    "direct_diag_clean_field_clean_hn_weight_total",
    "direct_diag_clean_field_clean_hn_weight_scale_total",
    "direct_diag_clean_field_balance_weight_total",
    "direct_diag_clean_field_pose_information_weight_total",
    "direct_diag_clean_field_diff_pnp_weight_total",
    "direct_diag_clean_field_diff_pnp_weight_scale_total",
    "direct_diag_surfel_loc_anchor_reg_loss_total",
    "direct_diag_surfel_loc_anchor_reg_loss_max",
    "direct_diag_surfel_loc_tangent_bound_total",
    "direct_diag_surfel_loc_tangent_bound_max",
    "direct_diag_surfel_loc_normal_bound_total",
    "direct_diag_surfel_loc_normal_bound_max",
    "mvinit_used_views",
