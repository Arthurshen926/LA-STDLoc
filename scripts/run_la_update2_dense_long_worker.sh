...
run_one() {
  ...
  if env \
      ...
      DENSEKL_RANK_WEIGHT="$DENSEKL_RANK_WEIGHT" \
      DENSEKL_RANK_MARGIN="$DENSEKL_RANK_MARGIN" \
      DENSEKL_RANK_TEACHER_CONFIDENCE="$DENSEKL_RANK_TEACHER_CONFIDENCE" \
      DENSEKL_RANK_MISS_TOPK="$DENSEKL_RANK_MISS_TOPK" \
      ...
      DENSEKL_ADVANTAGE_GATE="$DENSEKL_ADVANTAGE_GATE" \
      DENSEKL_ADVANTAGE_MIN_TE="$DENSEKL_ADVANTAGE_MIN_TE" \
      DENSEKL_ADVANTAGE_MIN_AE="$DENSEKL_ADVANTAGE_MIN_AE" \
      DENSEKL_ADVANTAGE_TE_SCALE="$DENSEKL_ADVANTAGE_TE_SCALE" \
      DENSEKL_ADVANTAGE_AE_SCALE="$DENSEKL_ADVANTAGE_AE_SCALE" \
      ...
      DENSEKL_SUPPORT_QUERY_SPLIT="$DENSEKL_SUPPORT_QUERY_SPLIT" \
      DENSEKL_QUERY_HOLDOUT_RATIO="$DENSEKL_QUERY_HOLDOUT_RATIO" \
      DENSEKL_QUERY_SPLIT_SEED="$query_split_seed" \
      DENSEKL_QUERY_SPLIT_MODE="$DENSEKL_QUERY_SPLIT_MODE" \
      DENSEKL_SYNTHETIC_VIEW_RATIO="$DENSEKL_SYNTHETIC_VIEW_RATIO" \
      DENSEKL_SYNTHETIC_VIEW_CANDIDATES="$DENSEKL_SYNTHETIC_VIEW_CANDIDATES" \
      DENSEKL_SYNTHETIC_VIEW_ALPHA_MIN="$DENSEKL_SYNTHETIC_VIEW_ALPHA_MIN" \
      DENSEKL_SYNTHETIC_VIEW_ALPHA_MAX="$DENSEKL_SYNTHETIC_VIEW_ALPHA_MAX" \
      DENSEKL_SYNTHETIC_VIEW_MIN_OBSERVABILITY="$DENSEKL_SYNTHETIC_VIEW_MIN_OBSERVABILITY" \
      DENSEKL_SYNTHETIC_VIEW_DESC_WEIGHT="$DENSEKL_SYNTHETIC_VIEW_DESC_WEIGHT" \
      DENSEKL_SYNTHETIC_VIEW_REPROJ_WEIGHT="$DENSEKL_SYNTHETIC_VIEW_REPROJ_WEIGHT" \
