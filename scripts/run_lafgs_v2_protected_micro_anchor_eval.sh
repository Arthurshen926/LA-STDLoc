...
# Evaluate protected add-only descriptor checkpoints with the frozen protocol.
...
TRAIN_ROOT="$ROOT/protected_descriptor_2048_v1"
...
for variant in step_0500 step_1000 blend_025 blend_050; do
  label="protected_2048_${variant}"
  state="$TRAIN_ROOT/anchor_map_${variant}.pt"
