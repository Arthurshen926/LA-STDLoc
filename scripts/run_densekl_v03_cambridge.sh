...
DENSEKL_RANK_WEIGHT=${DENSEKL_RANK_WEIGHT:-0.0}
DENSEKL_RANK_MARGIN=${DENSEKL_RANK_MARGIN:-0.2}
DENSEKL_RANK_TEACHER_CONFIDENCE=${DENSEKL_RANK_TEACHER_CONFIDENCE:-0.0}
DENSEKL_RANK_MISS_TOPK=${DENSEKL_RANK_MISS_TOPK:-1}
...
DENSEKL_ADVANTAGE_GATE=${DENSEKL_ADVANTAGE_GATE:-0}
DENSEKL_ADVANTAGE_MIN_TE=${DENSEKL_ADVANTAGE_MIN_TE:-0.0}
DENSEKL_ADVANTAGE_MIN_AE=${DENSEKL_ADVANTAGE_MIN_AE:-0.0}
DENSEKL_ADVANTAGE_TE_SCALE=${DENSEKL_ADVANTAGE_TE_SCALE:-10.0}
DENSEKL_ADVANTAGE_AE_SCALE=${DENSEKL_ADVANTAGE_AE_SCALE:-1.0}
...
DENSEKL_SUPPORT_QUERY_SPLIT=${DENSEKL_SUPPORT_QUERY_SPLIT:-0}
DENSEKL_QUERY_HOLDOUT_RATIO=${DENSEKL_QUERY_HOLDOUT_RATIO:-0.2}
DENSEKL_QUERY_SPLIT_SEED=${DENSEKL_QUERY_SPLIT_SEED:-2025}
DENSEKL_QUERY_SPLIT_MODE=${DENSEKL_QUERY_SPLIT_MODE:-sequence_block}
DENSEKL_SYNTHETIC_VIEW_RATIO=${DENSEKL_SYNTHETIC_VIEW_RATIO:-0.0}
DENSEKL_SYNTHETIC_VIEW_CANDIDATES=${DENSEKL_SYNTHETIC_VIEW_CANDIDATES:-1}
DENSEKL_SYNTHETIC_VIEW_ALPHA_MIN=${DENSEKL_SYNTHETIC_VIEW_ALPHA_MIN:-0.35}
DENSEKL_SYNTHETIC_VIEW_ALPHA_MAX=${DENSEKL_SYNTHETIC_VIEW_ALPHA_MAX:-0.65}
DENSEKL_SYNTHETIC_VIEW_MIN_OBSERVABILITY=${DENSEKL_SYNTHETIC_VIEW_MIN_OBSERVABILITY:-0.0}
DENSEKL_SYNTHETIC_VIEW_DESC_WEIGHT=${DENSEKL_SYNTHETIC_VIEW_DESC_WEIGHT:-0.0}
DENSEKL_SYNTHETIC_VIEW_REPROJ_WEIGHT=${DENSEKL_SYNTHETIC_VIEW_REPROJ_WEIGHT:-0.0}
...
ADVANTAGE_GATE_ARGS=()
if [[ "$DENSEKL_ADVANTAGE_GATE" == "1" ]]; then
  ADVANTAGE_GATE_ARGS+=(
    --loc_dense_advantage_gate
    --loc_dense_advantage_min_te "$DENSEKL_ADVANTAGE_MIN_TE"
    --loc_dense_advantage_min_ae "$DENSEKL_ADVANTAGE_MIN_AE"
    --loc_dense_advantage_te_scale "$DENSEKL_ADVANTAGE_TE_SCALE"
    --loc_dense_advantage_ae_scale "$DENSEKL_ADVANTAGE_AE_SCALE"
  )
  RUN_DENSE_POSE_CACHE=1
fi
...
SUPPORT_QUERY_ARGS=()
if [[ "$DENSEKL_SUPPORT_QUERY_SPLIT" == "1" ]]; then
  SUPPORT_QUERY_ARGS+=(
    --support_query_split
    --query_holdout_ratio "$DENSEKL_QUERY_HOLDOUT_RATIO"
    --query_split_seed "$DENSEKL_QUERY_SPLIT_SEED"
    --query_split_mode "$DENSEKL_QUERY_SPLIT_MODE"
  )
fi
...
if [[ "$NEED_DENSEKL_TRAIN" == "1" ]]; then
  "$PYTHON" train_locaware.py \
    ...
    --loc_dense_rank_weight "$DENSEKL_RANK_WEIGHT" \
    --loc_dense_rank_margin "$DENSEKL_RANK_MARGIN" \
    --loc_dense_rank_teacher_confidence "$DENSEKL_RANK_TEACHER_CONFIDENCE" \
    --loc_dense_rank_miss_topk "$DENSEKL_RANK_MISS_TOPK" \
    ...
    --synthetic_view_ratio "$DENSEKL_SYNTHETIC_VIEW_RATIO" \
    --synthetic_view_candidates "$DENSEKL_SYNTHETIC_VIEW_CANDIDATES" \
    --synthetic_view_alpha_min "$DENSEKL_SYNTHETIC_VIEW_ALPHA_MIN" \
    --synthetic_view_alpha_max "$DENSEKL_SYNTHETIC_VIEW_ALPHA_MAX" \
    --synthetic_view_min_observability "$DENSEKL_SYNTHETIC_VIEW_MIN_OBSERVABILITY" \
    --synthetic_view_desc_weight "$DENSEKL_SYNTHETIC_VIEW_DESC_WEIGHT" \
    --synthetic_view_reproj_weight "$DENSEKL_SYNTHETIC_VIEW_REPROJ_WEIGHT" \
