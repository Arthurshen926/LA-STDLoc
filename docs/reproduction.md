...
Use `--function-graph-shards 4 --provenance-shards 4` when host memory permits
parallel evidence construction. Shards preserve the global query indices and
PoseLib seeds; merged artifacts are semantically identical to the default
single-shard run.
