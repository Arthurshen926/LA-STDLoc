...
class ArtifactValidMaskBuilder:
    """Turns detector evidence into clean local regions usable by localization."""

    def __init__(self, config=None):
        self.config = config or ArtifactValidMaskConfig()
...
def save_valid_mask_png(valid_mask, path):
    import numpy as np
